...
const seedData = async () => {
  try {
    ...
    await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/vibestore');
    ...
    const productsData = [
      ...
      {
        _id: new mongoose.Types.ObjectId('60d5ec49f83f2a2408c4e402'), // Static recommendation target
    ...
    console.log(`Admin login: admin@velocityx.com / admin123`);
    console.log(`User login: user@velocityx.com / user123`);
    process.exit(0);
  } catch (error) {
